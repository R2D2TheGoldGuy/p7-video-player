    ...
    //FUNCTIONS
        ...
        function playVideo() {
            if (video.paused === true) {
                ...
                document.getElementById("play-pause-icon").src = "img/icons/pause-icon.png";
            } else {
                //Pause the video
                video.pause();
                //Update button img to Play icon
                document.getElementById("play-pause-icon").src = "img/icons/play-icon.png";
            }
        }
        ...
        function muteVideo() {
            ...
            document.getElementById("mute-icon").src = "img/icons/volume-off-icon.png";
        	} else {
        		// Unmute the video
        		video.muted = false;
        		// Update the button image to Volume Off
                document.getElementById("mute-icon").src = "img/icons/volume-on-icon.png";
        	}
        }
